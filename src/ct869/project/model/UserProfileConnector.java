...
public class UserProfileConnector {
		...
		public static boolean editProfile(String username, String profileBlurb) {
			...
			try {
				String sql = "UPDATE user SET profile_blurb = ? WHERE username = ?";
				...
				pstmt.setString(1, profileBlurb);
		...
		public static User userLogin(User user) {
			...
			try {
				String sql = "SELECT * FROM user WHERE username = ? AND passwd = MD5(?)";
				...
				//if user exists set the isValid variable to true
					...
					int positiveAP = rs.getInt("negative_AP");
					user.setPositiveAP(positiveAP);
					System.out.println("Positive Approval points: " + positiveAP);
					int negativeAP = rs.getInt("negative_AP");
					user.setNegativeAP(negativeAP);
					System.out.println("Positive Approval points: " + negativeAP);
					int neutralAP = rs.getInt("neutral_AP");
					user.setNeutralAP(neutralAP);
					System.out.println("Positive Approval points: " + neutralAP);
